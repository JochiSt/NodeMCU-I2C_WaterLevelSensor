...
F2 "Uout" I L 5550 3400 50 
F3 "Vref" I R 6500 3400 50 
$EndSheet
$Sheet
S 5550 3700 950  200 
U 5EE46703
F0 "4to20in 2" 50
F1 "4to20input.sch" 50
F2 "Uout" I L 5550 3800 50 
F3 "Vref" I R 6500 3800 50 
$EndSheet
$Comp
L power:+24V #PWR048
U 1 1 5EE4A753
...
U 1 1 5EF318CF
P 7250 3400
F 0 "L1" V 7440 3400 50  0000 C CNN
F 1 "L" V 7349 3400 50  0000 C CNN
F 2 "Inductor_SMD:L_0805_2012Metric" H 7250 3400 50  0001 C CNN
...
F 0 "#PWR065" H 7500 3100 50  0001 C CNN
...
F 0 "#PWR064" H 6950 3650 50  0001 C CNN
...
F 0 "C20" H 7065 3646 50  0000 L CNN
...
F 0 "#PWR066" H 7500 3650 50  0001 C CNN
...
F 0 "R24" H 6670 4796 50  0000 L CNN
F 1 "10k" H 6670 4705 50  0000 L CNN
...
F 0 "#PWR0107" H 6600 4700 50  0001 C CNN
...
U 1 1 5EDE69A2
P 6600 4400
F 0 "D7" V 6504 4558 50  0000 L CNN
F 1 "BPW34" V 6595 4558 50  0000 L CNN
F 2 "OptoDevice:Osram_DIL2_4.3x4.65mm_P5.08mm" H 6600 4575 50  0001 C CNN
F 3 "http://www.vishay.com/docs/81521/bpw34.pdf" H 6550 4400 50  0001 C CNN
	1    6600 4400
	0    1    1    0   
$EndComp
Wire Wire Line
...
MASTER
$Sheet
S 4200 2850 1050 2650
U 5E788D14
F0 "I2C Water Sensor" 50
F1 "I2C_WaterSensor.sch" 50
F2 "SDA" I L 4200 2950 50 
F3 "SCL" I L 4200 3050 50 
F4 "FREQIN" I R 5250 3000 50 
F5 "ADC0" I R 5250 3400 50 
F6 "ADC1" I R 5250 3800 50 
F7 "Vref" I R 5250 4100 50 
F8 "ADC2" I R 5250 4550 50 
F9 "DigOut1" I R 5250 4750 50 
F10 "DigOut2" I R 5250 4950 50 
F11 "DigIn1" I R 5250 5150 50 
F12 "DigIn2" I R 5250 5350 50 
$EndSheet
$Comp
L Connector_Generic:Conn_01x10 J15
U 1 1 5EF04A37
P 6000 5150
F 0 "J15" H 6080 5142 50  0000 L CNN
F 1 "Conn_01x10" H 6080 5051 50  0000 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x10_P2.54mm_Vertical" H 6000 5150 50  0001 C CNN
...
U 1 1 5EF4294B
P 5600 5550
F 0 "#PWR0109" H 5600 5400 50  0001 C CNN
...
U 1 1 5F0178A6
P 5400 2550
F 0 "J16" V 5364 2629 50  0000 L CNN
F 1 "Conn_01x02" V 5273 2629 50  0000 L CNN
F 2 "Connector_PinHeader_2.54mm:PinHeader_1x02_P2.54mm_Vertical" H 5400 2550 50  0001 C CNN
